...
#VAR_NAME='swsal'; LEVEL=9.572; SOURCE='glorys12v1aeq1erai_zlev_d'; TDOMAINID='rmm008FS-djf2'
#VAR_NAME='swtheta'; LEVEL=0.494; SOURCE='glorys12v1aeq1erai_zlev_d'; TDOMAINID='rmm008FS-djf3'
#LEVEL=9.572; SOURCE='glorys12v1aeq1erai_zlev_d'; TDOMAINID='rmm008FS-djf2'
#LEVEL=0.494; SOURCE='glorys12v1aeq1erai_zlev_d';
...
LAGS=list(range(-20,20+1))
#
# If using method 2, LAGS is a 2-tuple of start timedelta, and end timedelta
#LAGS=( datetime.timedelta(days=-20), datetime.timedelta(days=20) )
...
LAZY_LOAD=True
if not LAZY_LOAD:
    TIME_FIRST=cftime.DatetimeGregorian(2003,1,1)
