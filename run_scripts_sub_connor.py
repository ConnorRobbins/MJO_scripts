...
#FILENAME='nemo_get.py'
#FILENAME='pre_preprocess.py'
#FILENAME='preprocess.py'
#FILENAME='regrid.py'
#FILENAME='mean.py'
#FILENAME='anncycle.py'
#FILENAME ='filter_connor.py' ###FILENAME='filter.py'
FILENAME='lagged_mean.py'
#FILENAME='combine_levels.py'
#FILENAME='spatial_subset.py'

#FILENAME='tdomain_create.py'

#FILENAME='SA_from_SP.py'
#FILENAME='CT_from_pt.py'
#FILENAME='swpd_from_SA_and_tsc.py'

#FILENAME='SA_from_SP_no_time.py'
#FILENAME='CT_from_pt_no_time.py'
...
DIR1=os.path.join(os.path.sep,'gpfs','home','rgq13jzu','tmp','sub_'+TMPEXP)
...
# NV with exclusive flag, also use --mem=0 to allocate all memory
EXCLUSIVE=False
...
queue='compute-64-512' # new, use these
memory='12G'
runtime='6:00:00'
if FILENAME in ['mean.py','wndspd.py','nc2txt_time_series.py']:
    ...
    #runtime='1:00:00'
    pass
elif FILENAME in ['filter.py','filter_connor.py']:
    # filter.py ~9G erainterim_plev_d with splitblock true
    memory='70G' 
elif FILENAME in ['anncycle.py']:
    memory='12G' 
elif FILENAME in ['tdomain_create.py','nemo_get.py']:
    runtime='24:00:00'
elif FILENAME in ['lagged_mean.py']:
    runtime='3:00:00'
    ...
    memory='48G'
    runtime='18:00:00'
elif FILENAME in ['copernicus_get.py']:
    memory='48G'
    runtime='36:00:00'
elif FILENAME in ['pre_preprocess.py']:
    memory='24G'
    runtime='2:00:00'
elif FILENAME in ['SA_from_SP_no_time.py','CT_from_pt_no_time.py']:
    runtime='0:20:00'
    memory = '4G'
...
#LOOPVAR1=[2021,]
#LOOPVAR1=range(1998,2022+1)
#LOOPVAR1=range(1998,2022+1,5) # combine_latitudes.py
#LOOPVAR1=range(1998,2022+1,9) # copernicus_get.py, spatial_subset.py
...
######################################################
#LOOPVAR3=['ann'+str(xx).zfill(4) for xx in range(2003,2020+1)]

#LOOPVAR3=['rmm008djf'+str(xx).zfill(1) for xx in range(1,8+1) ]
#LOOPVAR3=['rmm008jja'+str(xx).zfill(1) for xx in range(1,8+1) ]
#LOOPVAR3=['rmm008all'+str(xx).zfill(1) for xx in range(1,8+1) ]

#LOOPVAR3=['rmm008FS-djf'+str(xx).zfill(1) for xx in range(1,8+1) ] 
#LOOPVAR3=['rmm008FS-jja'+str(xx).zfill(1) for xx in range(1,8+1) ] 
LOOPVAR3=['rmm008FS-all'+str(xx).zfill(1) for xx in range(1,8+1) ] 

#LOOPVAR3=['rmm008FS-djf'+str(xx).zfill(1) for xx in range(1,8+1) ] + ['rmm008FS-jja'+str(xx).zfill(1) for xx in range(1,8+1) ] + ['rmm008FS-all'+str(xx).zfill(1) for xx in range(1,8+1) ] 

#LOOPVAR3=['rmm008FS-PATAMA-all'+str(xx).zfill(1) for xx in range(1,8+1) ] 
#LOOPVAR3=['rmm008FS-PATAMARECENT-all'+str(xx).zfill(1) for xx in range(1,8+1) ] 
...
######################################################
#LOOPVAR4=['swsal','swtheta','ucur','vcur']

#LOOPVAR4=['swsal','swtheta']
#LOOPVAR4=['ucur','vcur']
...
######################################################
#LOOPVAR5=[0.494, 1.541, 2.645, 3.819]
#LOOPVAR5=[5.078, 6.440, 7.929, 9.572]
#LOOPVAR5=[11.405, 13.467, 15.810, 18.495]
#LOOPVAR5=[21.598, 25.211, 29.444, 34.434]
#LOOPVAR5=[40.344, 47.373, 55.764, 65.807]
#LOOPVAR5=[77.853, 92.326, 109.729, 130.666]
#LOOPVAR5=[155.850, 186.125, 222.475, 266.040]
#LOOPVAR5=[318.127, 380.213, 453.937, 541.088]
#LOOPVAR5=[643.566, 763.333, 902.339, 1062.440]
#LOOPVAR5=[1245.291, 1452.251, 1684.284, 1941.893]


#LOOPVAR5= [ 0.494, 1.541, 2.645, 3.819, 5.078, 6.440, 7.929, 9.572, 11.405, 13.467, 15.810, 18.495, 21.598, 25.211, 29.444, 34.434, 40.344, 47.373, 55.764, 65.807]
#LOOPVAR5=[77.853, 92.326, 109.729, 130.666, 155.850, 186.125, 222.475, 266.040, 318.127, 380.213, 453.937, 541.088, 643.566, 763.333, 902.339, 1062.440, 1245.291, 1452.251, 1684.284, 1941.893]


#LOOPVAR5=[0.494, 1.541, 2.645, 3.819, 5.078, 6.440, 7.929, 9.572, 11.405, 13.467, 15.810, 18.495, 21.598, 25.211]
#LOOPVAR5=[29.444, 34.434, 40.344, 47.373, 55.764, 65.807, 77.853, 92.326, 109.729, 130.666, 155.850, 186.125, 222.475]
#LOOPVAR5=[ 266.040, 318.127, 380.213, 453.937, 541.088, 643.566, 763.333, 902.339, 1062.440, 1245.291, 1452.251, 1684.284, 1941.893]


#LOOPVAR5= [ 0.494, 1.541, 2.645, 3.819, 5.078, 6.440, 7.929, 9.572, 11.405, 13.467, 15.810, 18.495, 21.598, 25.211, 29.444, 34.434, 40.344, 47.373, 55.764, 65.807, 77.853, 92.326, 109.729, 130.666, 155.850, 186.125, 222.475, 266.040, 318.127, 380.213, 453.937, 541.088, 643.566, 763.333, 902.339, 1062.440, 1245.291, 1452.251, 1684.284, 1941.893]




# FULL LIST #LOOPVAR5 = [ 0.494, 1.541, 2.645, 3.819, 5.078, 6.440, 7.929, 9.572, 11.405, 13.467, 15.810, 18.495, 21.598, 25.211, 29.444, 34.434, 40.344, 47.373, 55.764, 65.807, 77.853, 92.326, 109.729, 130.666, 155.850, 186.125, 222.475, 266.040, 318.127, 380.213, 453.937, 541.088, 643.566, 763.333, 902.339, 1062.440, 1245.291, 1452.251, 1684.284, 1941.893, 2225.078, 2533.336, 2865.703, 3220.820, 3597.032, 3992.484, 4405.224, 4833.291, 5274.784, 5727.917 ]



#LOOPVAR5=[-80]
#LOOPVAR5=[xx for xx in range(-170,180,10)]
#--------------------------------------------------------------------
...
f1=open(os.path.join(os.path.sep,'gpfs','home','rgq13jzu','MJO_scripts',FILENAME))
lines=f1.readlines()
...
index=0
scriptfile_original=os.path.join(os.path.sep,'gpfs','home','rgq13jzu','MJO_scripts',FILENAME)
        ...
        for var3 in LOOPVAR3: 
            for var4 in LOOPVAR4:
                for var5 in LOOPVAR5:
                    ...
                    dir99=os.path.join(os.path.sep,'gpfs','home','rgq13jzu','MJO_scripts')
                    ...
                    fout.write('#SBATCH --mail-user=rgq13jzu@uea.ac.uk\n')
                    ...
                    #
                    #fout.write('#SBATCH --exclusive\n')
                    #fout.write('#SBATCH --exclusive=user\n')
                    #
                    fout.write('\n')
                    #
                    ...
                    #
                    if FILENAME == 'pre_preprocess.py':
                        fout.write('module load cdo\n')
                    #
                    if FILENAME == 'nemo_get.py':
                        fout.write('source activate cmt_1.0\n')
                    else:
                        fout.write('source activate MJO_env\n')
                    #
