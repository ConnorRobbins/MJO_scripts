"""Calculate seawater potential density from absolute salinity and conservative temperature using gsw."""
...
for year in iter_year:
    for month in iter_month:
        ...
        aa.year=year
        aa.month=month
        aa.f_sea_water_potential_density()
