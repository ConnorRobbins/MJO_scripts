...
VAR_1='swtheta'; contour_levels_1=np.array([-0.04,-0.01,-0.005,-0.001,0.001,0.005,0.01,0.04])
VAR_2='swsal'; contour_levels_2=np.array([-0.04,-0.01,-0.001,0.001,0.01,0.04])
...
MJO_OLR_CENTRE_LONGITUDES_BY_PHASE = [90]
